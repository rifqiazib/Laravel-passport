...
<body>
  <div class="min-h-screen flex items-center justify-center bg-white">
    <form action="{{ route('do.login') }}" method="POST" class="flex flex-col items-center font-montserrat w-3/12 bg-slate-100 p-8 rounded shadow-lg">
      @csrf
      ...
      <a href="#" class="self-start text-blue-500 mb-4">Forgot password?</a>
